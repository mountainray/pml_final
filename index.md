...
## Synopsis
Exercise is great for people, though injury and enjoyment vary with technique.  The experience may be enhanced using technology to classify technique, and a model-based classification of these techniques are the focus of this analysis.  In particular, the simple dumbbell lift provides a rich array of data and is ripe for trying out -- in this case three -- different models.   [**Addtional github details (Rmd/md versions)**](https://github.com/mountainray/pml_final).
